    ...
    if (ImGui::Begin("variant", &bOpenLocal))
    {
        ...
        if (ImGui::CollapsingHeader("Visuals"))
        {
            ...
            if (Vars.bChams)
            {
                ...
                ImGui::Checkbox("Enemies##chams",   &Vars.bChamsEnemies);   ImGui::SameLine();
                ImGui::Checkbox("Teammates##chams", &Vars.bChamsTeammates); ImGui::SameLine();
                ...
                if (Vars.bChamsDouble)
                {
                    ...
                    ImGui::ColorEdit4("Enemy##c1", Vars.flChamsEnemyColor,  ImGuiColorEditFlags_NoInputs); ImGui::SameLine();
                    ImGui::ColorEdit4("Team##c1",  Vars.flChamsTeamColor,   ImGuiColorEditFlags_NoInputs); ImGui::SameLine();
                    ImGui::ColorEdit4("Self##c1",  Vars.flChamsSelfColor,   ImGuiColorEditFlags_NoInputs);
                    ImGui::TextDisabled("Pass 2");
                    ImGui::ColorEdit4("Enemy##c2", Vars.flChamsEnemyColor2, ImGuiColorEditFlags_NoInputs); ImGui::SameLine();
                    ImGui::ColorEdit4("Team##c2",  Vars.flChamsTeamColor2,  ImGuiColorEditFlags_NoInputs); ImGui::SameLine();
